function gl = simEnergyPlusLoadLedTransp(location, simType, seasonLength, firstDay, fileLabel, mature, intensity)
...
% firstDay = 300; % Beginning of season (days since January 1)
    ...
    %% turn transpiration into an input and use the one from the LED lamp
    load('M:\PhD\Models\git\gitwur\GreenLight\mvCanAirLedBigBoil.mat', 'mvCanAirLedBigBoil');
    addInput(gl, 'mvCanAir', mvCanAirLedBigBoil.val);
