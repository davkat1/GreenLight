function gl = simEnergyPlusHighEffLed(location, simType, seasonLength, firstDay, fileLabel, mature, intensity)
...
% firstDay = 300; % Beginning of season (days since January 1)
    ...
    if strcmp(simType, 'led')
        ...
        setParam(gl, 'etaLampPar', 0.84); % ~5umol/m2/s
        setParam(gl, 'thetaLampMax', intensity*0.5/0.84); % maintain PPFD
    end
