function gl = simEnergyPlusHighInt(location, simType, seasonLength, firstDay, fileLabel, mature, intensity)
...
%         setParam(gl, 'etaLampPar', 0.67);
    elseif strcmp(simType, 'hps')
        setParam(gl, 'thetaLampMax', intensity);
        setParam(gl, 'capLamp', gl.p.capLamp.val*intensity/110);
        setParam(gl, 'cHecLampAir',gl.p.cHecLampAir.val*intensity/110);
    end
