% fig11IncomingOutgoingEnergy Present the yearly incoming and outgoing energy flows for selected heating by light scenarios.
% Used to generate Figure 11 in:
