% FIG509HEATBYLIGHTFOURDAYSLAMPINTENSITYBUFFERSIZE Present four days of heating by light scenarios with various lamp intensities and buffer sizes.
% Used to generate Figure 5.9 in:
