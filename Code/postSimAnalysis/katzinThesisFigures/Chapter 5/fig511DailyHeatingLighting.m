% FIG511DAILYHEATINGLIGHTING print out the daily heating and lighting input of a simulated greenhouse. 
% Used to generate Figure 5.11 in:
...
% Get daily means of heating ang lighting, assumes that outputs are in
