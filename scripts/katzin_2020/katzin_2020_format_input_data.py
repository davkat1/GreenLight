...
# Assuming that the original data files are in greenlight/models/katzin_2021/input_data/katzin_2020_original
# See docstring above on how to obtain these files
input_dir = os.path.abspath(os.path.join(project_dir, "models", "katzin_2021", "input_data", "katzin_2020_original"))
output_dir = os.path.abspath(os.path.join(project_dir, "models", "katzin_2021", "input_data", "katzin_2020_formatted"))
